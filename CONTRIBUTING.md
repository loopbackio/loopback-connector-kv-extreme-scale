...
Thank you for your interest in `loopback-connector-kv-extreme-scale`,
an open source project administered by StrongLoop.

Contributing to `loopback-connector-kv-extreme-scale` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License * Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-kv-extreme-scale)
